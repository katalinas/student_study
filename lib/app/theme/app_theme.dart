...
abstract final class AppTheme {
  ...
  static ThemeData _buildTheme(Brightness brightness) {
    ...
    final colorScheme = ColorScheme(
      ...
      primaryContainer: isLight ? AppColors.primaryLight : const Color(0xFF1A3A5C),
      onPrimaryContainer: isLight ? const Color(0xFF001D3B) : const Color(0xFFD1E4FF),
      ...
      tertiaryContainer: isLight ? AppColors.tertiaryLight : const Color(0xFF1B4D30),
      onTertiaryContainer: isLight ? const Color(0xFF002106) : const Color(0xFFA7F5C0),
      ...
      surfaceContainerHighest: isLight ? const Color(0xFFE7E0EC) : const Color(0xFF2D2D2D),
      outline: isLight ? const Color(0xFF79747E) : const Color(0xFF938F99),
      outlineVariant: isLight ? AppColors.divider : AppColors.darkDivider,
      shadow: Colors.black,
      scrim: Colors.black,
      inverseSurface: isLight ? const Color(0xFF313033) : const Color(0xFFE6E1E5),
      onInverseSurface: isLight ? const Color(0xFFF4EFF4) : const Color(0xFF313033),
      inversePrimary: isLight ? const Color(0xFFB0C6FF) : AppColors.primary,
    );
